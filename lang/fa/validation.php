...
return [
    ...
    */
    ...
    'required_with' => 'تکمیل گزینه :attribute زمانی که مقدار :values موجود است الزامی است',
    'required_with_all' => 'تکمیل گزینه :attribute زمانی که مقادیر :values موجود است الزامی می باشد',
    'required_without' => 'تکمیل گزینه :attribute زمانی که مقدار :values موجود نیست الزامی است',
    'required_without_all' => 'تکمیل گزینه :attribute زمانی که هیچ کدام از مقادیر :values موجود نیست الزامی است',
    ...
    */
    ...
    'custom' => [
        ...
        'tags-exists' => 'برخی از برچسب‌های انتخاب‌شده نامعتبر هستند.'
    ],
